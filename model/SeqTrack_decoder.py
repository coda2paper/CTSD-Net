...
class SeqTrackDecoder(nn.Module):
    ...
    def forward(self, src, pos_embed, seq):
        ...
        # tgt是词经过embedding后的特征-5,1,256，memory是图像特征-256,1,256，
        # pos_embed是一个权重-256,1,256，query_embed是一个权重-256,1,256，tgt_mask是因果掩码下三角矩阵-5,5，
...
class TransformerDecoder(nn.Module):
    ...
    def forward(self, tgt, memory,
        ...
        output = tgt
        # tgt是词经过embedding后的特征-5,1,256，memory是图像特征-256,1,256，query_embed是一个权重，tgt_mask是因果掩码下三角矩阵-5,5
        intermediate = []
